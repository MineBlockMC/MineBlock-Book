...
在 MineBlock，有五种可购买的会员等级，分别是 VIP、VIP+、MVP、MVP+ 和 MVP++。

不同的会员等级具有不同的特权，这些特权能够提升你在 MineBlock 的游戏体验，包括独特的聊天文字颜色、欢迎信息、特效等不影响游戏平衡的特权。
...
特殊会员等级授予给对 MineBlock 具有特殊意义的玩家，这类会员等级具有特殊的获取条件，并且具有与可购买的会员等级完全不同的特权。
