...
我们非常重视玩家们的隐私安全，因此请您完整阅读这份隐私政策，在 MineBlock 服务器上游玩即代表您同意隐私政策的所有内容。
...
* 当您选择联系我们时，您将提供：
    * 邮箱地址
    * QQ 号或其他即时通讯软件账号
* 当您在 MineBlock 服务器上充值时，支付处理方将提供：
    * 真实姓名
    * 支付宝登录用户名（如果使用支付宝）
    * 微信唯一 ID（如果使用微信）
...
MineBlock 为我们的玩家们提供了许多服务。这些服务可能分布在世界各地，各地法律对数据的存放规定亦有差异，因此请根据您的自身情况，了解您的数据将会如何存放。

如果您游玩 MineBlock 的 Minecraft 社区服务器，您的数据会存放至位于中国上海的腾讯云服务器，适用中华人民共和国法律。

如果您访问并注册了 MineBlock 主站的账号，您的数据会存放至位于日本东京的腾讯云服务器，适用中华人民共和国法律和日本国法律。

对于此处未列出的其他服务，我们不收集您的信息。
...
根据《中华人民共和国网络安全法》的规定，我们有义务保留您的部分个人信息（如真实姓名），用于公安机关的刑事犯罪调查或接受政府部门的审查。
